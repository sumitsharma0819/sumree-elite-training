...
const days={
  ...
  d6:[
    mkEx('Spider Curl','AR','arms','Biceps','Dumbbells','3 × 10–12','Light','load-light','Post-hike arm work — strict and focused. Pump quality, not load.','Add Reps First','Progress reps. Arm work after hike stays conservative by design.','60 sec','https://www.youtube.com/watch?v=jmXXRM755MM'),
    mkEx('Hammer Curl','AR','arms','Brachialis','Dumbbells','3 × 10–12','Light','load-light','Arm thickness work. Keep strict, no swinging after a long hike.','Add Reps First','Add reps before weight. Fatigue from the hike means load is not the priority.','60 sec','https://www.youtube.com/watch?v=BRVDS6HVR9Q'),
    ...
    mkEx('Farmer Carry','GR','grip','Grip/Core','Dumbbells','2 × 25–35 yd','Moderate','load-moderate','Short loaded carries reinforce grip, traps, and trunk without needing a heavy lower-body demand after the hike.','Add Load Gradually','Add a small load jump only when both carries are completed without grip breakdown.','75 sec','https://www.youtube.com/watch?v=NH7Xv-7NQNQ'),
    mkEx('Dead Bug','CO','core','Core','Bodyweight','2 × 8/side','Rehab','load-rehab','Simple core control to finish the day without beating up the hips or low back.','Add Pause Duration','Add a 1–2 second hold at extension before any harder variation.','60 sec','https://www.youtube.com/watch?v=UIL7VI5_EQg')
  ]
};
