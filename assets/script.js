...
const days={
  ...
  d4:[
    ...
    mkEx('Bent-Knee Calf Raise','LG','legs','Soleus','Bodyweight / DB','2–3 × 15–20','Light','load-light','Extra soleus-focused calf work to bring calves closer to quad development and improve ankle endurance.','Add Reps First','Build to 20 smooth reps with a deep stretch and hard top squeeze before adding load.','45–60 sec','https://www.youtube.com/watch?v=KcTEGifMTDY'),
