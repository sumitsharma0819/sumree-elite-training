...
const trainSessionData={
  d1:{title:'Monday Push',note:'Bench-led push day with upper chest, shoulders, triceps, forearms, and trunk work. Long-session friendly.',badge:'~95–110 min · Press + arms',focus:'Chest + shoulders + triceps',progress:'Top set decides load next time',primer:'Shoulder day + push primer',watch:'Left shoulder quiet, clean lockout, no sloppy arching'},
  d2:{title:'Tuesday Pull',note:'Lat width, upper-back thickness, traps, biceps, forearms, carries, and trunk work. Built for a long session.',badge:'~100–115 min · Pull + arms',focus:'Lats + biceps + traps',progress:'Own top reps before adding load',primer:'Ankle day + pull primer',watch:'Scap control, no low-back takeover, keep curls strict'},
  d3:{title:'Wednesday Active Recovery',note:'Recovery-support session with guided mobility and tissue prep so Thursday legs perform better, not worse.',badge:'20–30 min · Restore',focus:'Circulation + tissue quality',progress:'No load chase today',primer:'Zone 2 + mobility flow',watch:'Walk, mobility, and zero ego'},
  d4:{title:'Thursday Legs',note:'Right-leg bias day built around step-ups, quads, glutes, calves, and simpler asymmetry work. No single-leg DB RDL.',badge:'~100–115 min · Lower body',focus:'Right-leg rebuild + calves',progress:'Reps first until knee/ankle stay quiet',primer:'Knee day + leg primer',watch:'Right knee tracking, ankle pressure, and stable step-ups'},
  d5:{title:'Friday Upper',note:'Your longest upper-body day: bench, press, back, traps, delts, biceps, triceps, forearms, and core. Work-from-home volume day.',badge:'~120–150 min · Upper + aesthetics',focus:'Delts + arms + upper chest + traps',progress:'Micro-load only after full control',primer:'Shoulder day + upper pump primer',watch:'Own contractions, keep quality high even late in the session'},
  d6:{title:'Saturday Arms + Conditioning',note:'Monthly hike optional. Default weekly Saturday is arms, conditioning step-ups, carries, traps, forearms, and core.',badge:'~80–105 min · Arms + conditioning',focus:'Arms + calorie burn + trunk',progress:'Pump quality + clean weekly progression',primer:'Ankle tune-up + arm switch-on',watch:'Keep step-ups crisp and conditioning clean, not sloppy'},
...
const days={
  d1:[
    mkEx('Barbell Bench Press','CH','chest','Chest','Barbell','4 × 5–8','Heavy','load-heavy','Primary strength anchor. You love this lift and it should stay the main chest/triceps driver.','Add Weight When Earned','Add weight only after all 4 sets hit 8 clean reps at ≤RPE 8 with stable bar path for two straight exposures.','2.5–3 min','https://www.youtube.com/watch?v=gRVjAtPip0Y'),
    mkEx('Low-Incline Neutral-Grip DB Press','CH','chest','Upper Chest','Dumbbells + bench','4 × 8–10','Moderate','load-moderate','Upper-chest priority press with a shoulder-friendlier grip. This keeps chest moving without beating up the shoulder.','Add Reps First','Move from 8→10 reps first. Add 5 lb total only when all sets reach 10 with zero shoulder instability.','2 min','https://www.youtube.com/shorts/W9FzXjKbYdE'),
    mkEx('Shoulder Press (Dumbbell)','SH','shoulders','Shoulders','Dumbbells','3 × 8–10','Moderate','load-moderate','You enjoy this lift and your delts respond well. It stays as a major visible-muscle movement.','Add Weight When Earned','Add weight only when all 3 sets hit 10 clean reps with no lean-back or shoulder pinch.','90 sec','https://www.youtube.com/watch?v=qEwKCR5JCog'),
    mkEx('Low-Incline DB Squeeze Press','CH','chest','Chest','Dumbbells + bench','2 × 12–15','Light','load-light','Chest isolation volume without needing more joint-heavy pressing. Hard inward squeeze on every rep.','Add Reps First','Keep the same weight until both sets reach 15 with a hard squeeze and no shoulder drift.','75 sec','https://www.youtube.com/watch?v=sC-PHtkYqI0'),
    mkEx('Lean-Away DB Lateral Raise','SH','shoulders','Shoulder Cap','Dumbbell','4 × 12–15','Light','load-light','High-priority width work. More lateral-delt volume is still one of the fastest ways to improve your public-facing look.','Add Reps First','Add reps and squeeze quality first. Add tiny load only when all 4 sets hit 15 with zero swing.','60 sec','https://www.youtube.com/watch?v=S7Bjyw2ccg0'),
    mkEx('DB Rolling Triceps Extension','AR','arms','Triceps','Dumbbells','4 × 8–10','Moderate','load-moderate','Main triceps size builder. Arms stay openly biased because they are the most visible body part day to day.','Add Weight When Earned','Add reps to 10 first. Add weight only when every rep stays smooth and elbow path stays pain-free.','75 sec','https://www.youtube.com/watch?v=6IrhvGp8kRg'),
    mkEx('Seated Overhead DB Extension','AR','arms','Triceps Long Head','Dumbbell','3 × 10–12','Moderate','load-moderate','Long-head triceps volume to keep the back side of the arm growing.','Add Weight When Earned','Progress reps before weight. Add the smallest jump when all 3 sets reach 12 with no shoulder discomfort.','60 sec','https://www.youtube.com/watch?v=fYqswDVbJDg'),
    mkEx('Push-Up Plus','CH','chest','Serratus','Bodyweight','1 × 12–15','Rehab','load-rehab','Kept as one shoulder-health set. This is here for scap control, not fatigue.','Add Control Only','Do not chase load. Add a rep or a pause only when shoulder stays perfectly centered.','60 sec','https://www.youtube.com/watch?v=_l3ySVKYVJ8'),
    mkEx('Seated DB Wrist Extension','GR','grip','Wrist / Forearm','Dumbbell','2 × 15–20/side','Light','load-light','Direct wrist-extensor work to support forearm look and elbow health from all the pressing and arm work.','Add Reps First','Hit 20 clean reps with a full top squeeze before adding the smallest load jump.','45 sec','https://www.youtube.com/watch?v=6TtkRqPjmsg'),
    mkEx('RKC Plank','CO','core','Core','Bodyweight','2 × 25–40s','Rehab','load-rehab','Trunk stiffness for low-back protection and better abdominal control from the side profile.','Add Time Only','Add 5–10 seconds per set before any harder variation.','60 sec','https://www.youtube.com/watch?v=0c1np4dV7ec'),
    mkEx('Reverse Crunch','CO','core','Lower Abs','Bodyweight / bench','3 × 12–15','Light','load-light','Extra lower-ab control work. This will not spot-reduce fat, but it helps trunk control and adds small-volume abdominal work.','Add Reps First','Add reps first. Add a 1-second squeeze only after 15 clean reps are easy.','45–60 sec','https://www.youtube.com/watch?v=JB2oyawG9KI'),
    mkEx('Suitcase Carry','CO','core','Obliques / Core','Dumbbell','2 × 25–35 yd/side','Moderate','load-moderate','Anti-side-bend carry to train obliques, trunk stiffness, and support the love-handle area visually through better posture.','Add Load Gradually','Add a small load jump only when both carries are completed without leaning or losing position.','60–75 sec','https://www.youtube.com/watch?v=hU0GfKBZaUU')
  ],
  d2:[
    mkEx('Pull-Ups (Assisted if needed)','BK','back','Lats','Rack / Pull-up bar','4 × 5–8','Heavy','load-heavy','Primary back-width strength movement and neural driver for the V-taper.','Add Reps First','Add weight only once all 4 sets hit 8 clean reps from a dead hang.','2.5 min','https://www.youtube.com/watch?v=ZHllQTJf7eA'),
    mkEx('Chest-Supported Incline Row','BK','back','Mid-Back','Dumbbells + bench','4 × 8–10','Heavy','load-heavy','Safe heavy row that matches the kind of work you are already handling well.','Add Weight When Earned','Add load when all 4 sets reach 10 with chest glued to bench and no torso bounce.','2 min','https://www.youtube.com/watch?v=vmX58YYK3-8'),
    mkEx('Single-Arm Lat Row','BK','back','Lats','Dumbbell + bench','3 × 10–12/side','Moderate','load-moderate','Lat-focused hypertrophy. Pull elbow toward hip to bias width instead of just mid-back fatigue.','Add Reps First','Add reps first. Add weight once all sets hit 12 and lats are doing more work than arms.','90 sec','https://www.youtube.com/shorts/q65uDGJ9ZPs'),
    mkEx('Straight-Arm DB Pullover','BK','back','Lats','Dumbbell','2 × 12–15','Light','load-light','Stretch-position lat work to reinforce the V-taper without low-back stress.','Add Reps First','Progress reps first. Add weight only when the full range stays pain-free and lat-loaded.','75 sec','https://www.youtube.com/watch?v=QZ_UC5SjvK4'),
    mkEx('DB Shrug','BK','back','Traps','Dumbbells','4 × 10–15','Moderate','load-moderate','You enjoy shrugs and they build visible upper-trap presence from the front and side.','Add Weight When Earned','Add weight only when all 4 sets hit 15 with a hard top squeeze and no rolling.','75 sec','https://www.youtube.com/watch?v=cJRVVxmytaM'),
    mkEx('Standing DB Curl','AR','arms','Biceps','Dumbbells','4 × 8–10','Moderate','load-moderate','Main biceps builder. Arms keep a clear bias here.','Add Weight When Earned','Add reps to the top of range, then increase by 2.5–5 lb total only if there is zero swing.','75 sec','https://www.youtube.com/watch?v=6DeLZ6cbgWQ'),
    mkEx('Seated Incline Curl (Dumbbell)','AR','arms','Biceps Peak','Dumbbells + incline bench','3 × 10–12','Light','load-light','You are already tolerating this pattern well. It stays as the stricter biceps stretch movement.','Add Reps First','Progress reps before weight. Load only after all 3 sets hit 12 with perfect elbow path.','60 sec','https://www.youtube.com/watch?v=soxrZlIl35U'),
    mkEx('Hammer Curl','AR','arms','Brachialis / Forearm','Dumbbells','2 × 10–12','Moderate','load-moderate','Extra visible arm thickness and forearm carryover.','Add Weight When Earned','Add weight only when both sets hit 12 with zero swing and neutral wrist position.','60 sec','https://www.youtube.com/watch?v=BRVDS6HVR9Q'),
    mkEx('Reverse Wrist Curl','GR','grip','Forearm Extensors','Dumbbells','2 × 15–20','Light','load-light','Direct forearm extensor work so forearm training stays visible and balanced.','Add Reps First','Build to 20 clean reps with zero elbow swing before increasing load.','45 sec','https://www.youtube.com/watch?v=krZ6pWGZ8xo'),
    mkEx('Farmer Carry','GR','grip','Grip/Core','Dumbbells','3 × 30–40 yd','Moderate','load-moderate','You are already doing these well. Great for grip, traps, trunk stiffness, and real-world presence.','Add Load Gradually','Add 2.5–5 lb per hand once all carries are completed without grip breakdown.','75 sec','https://www.youtube.com/watch?v=NH7Xv-7NQNQ'),
    mkEx('Side Plank','CO','core','Core','Bodyweight','2 × 25–35s/side','Rehab','load-rehab','Anti-lateral-flexion core work to support carries and improve trunk stability.','Add Time Only','Add 5 seconds per side before progressing any harder.','45–60 sec','https://www.youtube.com/watch?v=K2VljzCC16g'),
    mkEx('Suitcase Carry','CO','core','Obliques / Core','Dumbbell','2 × 25–35 yd/side','Moderate','load-moderate','Extra anti-side-bend work for trunk control and calorie expenditure.','Add Load Gradually','Add a small load jump only when both carries are completed without leaning or torso drift.','60–75 sec','https://www.youtube.com/watch?v=hU0GfKBZaUU')
  ],
  d3:[
    ...
    mkEx('Clamshells','LG','legs','Glute Med','Mini-band','2–3 × 12–15/side','Rehab','load-rehab','Hip-stability work that supports knee tracking and pelvic control for the right leg.','Add Reps First','Own the top range and glute squeeze before increasing band tension.','45–60 sec','https://youtu.be/LKtEwJ4s93o'),
    ...
    mkEx('Single-Leg Balance (Supported if needed)','LG','legs','Ankle Stability','Bodyweight','2 × 30 sec/side','Rehab','load-rehab','Proprioception rebuild for ankles and feet without adding fatigue. Fingertip support is allowed.','Add Time Only','Add 5–10 seconds only when balance stays controlled without toe-gripping or panic.','45 sec','https://www.youtube.com/shorts/T2WwK2JT2d0'),
    mkEx('Band Pull-Aparts','SH','shoulders','Rear Delts / Scap','Band','2 × 20','Rehab','load-rehab','Shoulder maintenance and scapular positioning work on a low-fatigue day.','Add Reps First','Progress reps or pause quality before using a stiffer band.','45 sec','https://www.youtube.com/watch?v=stwYTTPXubo'),
    mkEx('Bent-Knee Calf Raise','LG','legs','Soleus','Bodyweight / DB','2 × 15–20','Light','load-light','Low-intensity soleus work keeps weekly calf frequency high without bloating leg day.','Add Reps First','Build to 20 smooth reps with a deep stretch and hard top squeeze before adding load.','45–60 sec','https://www.youtube.com/watch?v=KcTEGifMTDY'),
    mkEx('Standing Calf Stretch','LG','legs','Calf Mobility','Wall','60 sec/side','Rehab','load-rehab','Keeps calf-Achilles tissue length and ankle motion ready for hikes and step-ups.','Add Relaxed Range','Let the heel settle lower over time without bouncing or forcing range.','30 sec','https://www.youtube.com/watch?v=LntxVU3jpgo'),
  ...
  d4:[
    mkEx('Romanian Deadlift','LG','legs','Posterior Chain','Barbell','4 × 6–8','Heavy','load-heavy','Primary posterior-chain strength movement. Lower rep, cleaner work suits your current strength better than endless high-rep fatigue.','Add Weight When Earned','Add load only when bar stays close, back stays flat, and all 4 sets hit 8 clean reps.','2.5 min','https://www.youtube.com/watch?v=3VXmecChYYM'),
    mkEx('Dumbbell Step-Ups','LG','legs','Right-Leg Bias','Dumbbells','L: 3 × 8/side, R: 4 × 8/side','Moderate','load-moderate','This is now the main asymmetry tool. Right side goes first and keeps the extra set until control and confidence match the left.','Add Weight When Earned','Increase range control first, then reps. Add load only when both sides are stable and the right knee/ankle stay quiet the next day.','90 sec','https://www.youtube.com/watch?v=dQqApCGd5Ss'),
    mkEx('Heels-Elevated Goblet Squat','LG','legs','Quads','Dumbbell / KB','4 × 10–12','Moderate','load-moderate','Simple bilateral quad work to keep leg training productive without another high-skill single-leg demand.','Add Reps First','Add reps to 12 first. Add weight once all sets are clean with heels elevated throughout.','90 sec','https://www.youtube.com/watch?v=CMH5QYN4saE'),
    mkEx('Paused Hip Thrust','LG','legs','Glutes','Dumbbell / Barbell + bench','4 × 8–12','Moderate','load-moderate','Simple glute builder that supports hip drive, pelvis control, and right-left balance without tricky balance demands.','Add Weight When Earned','Add weight after all sets reach 12 with a 2-second squeeze and no low-back compensation.','90 sec','https://www.youtube.com/watch?v=29OfN4ztW_g'),
    mkEx('Step-Ups (low box pump set)','LG','legs','Right-Leg Control','Bodyweight or light DB','L: 1 × 12/side, R: 2 × 12/side','Light','load-light','Extra low-skill right-leg volume. This replaces the single-leg DB RDL completely and keeps the asymmetry work simple.','Add Reps First','Keep these smooth and controlled. Add weight only after all sets are easy and completely stable.','60–75 sec','https://www.youtube.com/watch?v=dQqApCGd5Ss'),
    mkEx('Spanish Squat Iso Hold','LG','legs','Knee Tendon / Quads','Heavy band or strap','3 × 25–40 sec','Rehab','load-rehab','Much simpler knee-friendly tendon work. Lets you train quad tension and patellar tendon capacity without the awkward reverse nordic position.','Add Time First','Build to 40 seconds per set first. Then increase band tension or sit slightly deeper only if knees stay quiet.','60–75 sec','https://www.youtube.com/watch?v=Vb4Pn-zsFGc'),
    mkEx('Single-Leg Calf Raise','LG','legs','Calf','Bodyweight / DB','L: 3 × 12–15, R: 4 × 12–15','Moderate','load-moderate','Main calf movement. Right calf keeps the extra set until symmetry improves.','Add Weight When Earned','Add reps across all sets first. Add load only when full ROM is owned with a 1-second pause at the top.','60 sec','https://www.youtube.com/watch?v=KcTEGifMTDY'),
    mkEx('Standing DB Calf Raise','LG','legs','Calf Mass','Dumbbells','3 × 12–15','Moderate','load-moderate','Extra bilateral calf volume because you enjoy calf work and calves still lag quads slightly.','Add Weight When Earned','Add reps to 15 first. Add load only when stretch and top squeeze stay honest.','60 sec','https://www.youtube.com/watch?v=KcTEGifMTDY'),
    mkEx('Tibialis Raise','LG','legs','Shin','Wall / bodyweight','3 × 15–20','Rehab','load-rehab','Shin strength and downhill control — helps ankle stability and protects hiking mechanics.','Add Reps Only','Progress reps only. Add external load only once 20 reps feel easy with a 1-second pause.','45 sec','https://www.youtube.com/watch?v=VzIcGAgBiaM'),
    mkEx('Wrist Roller','GR','grip','Forearm Burn','Wrist roller / plate + rope','2 rounds','Moderate','load-moderate','Kept on leg day to satisfy your forearm priority and because you tolerate it well already.','Add Time or Weight','Add one extra up-and-down pass first, then add a small amount of weight.','60 sec','https://www.youtube.com/watch?v=-lOFG0U_rlY'),
    mkEx('Dead Bug','CO','core','Core','Bodyweight','2 × 8/side','Rehab','load-rehab','Anti-extension core control for low-back protection and better abdominal bracing.','Add Pause Duration','Add a 1–2 second hold at extension before any harder variation.','60 sec','https://www.youtube.com/watch?v=UIL7VI5_EQg'),
    mkEx('Side Plank Hip Lift','CO','core','Obliques','Bodyweight','2 × 10–12/side','Light','load-light','Extra oblique/trunk work for better side-profile control and more total abdominal training volume.','Add Reps First','Add reps to 12 first before increasing time or adding a pause.','45–60 sec','https://www.youtube.com/watch?v=E0u-u4K5CqQ')
  ],
  d5:[
    mkEx('Barbell Bench Press','CH','chest','Chest','Barbell','3 × 6–8','Heavy','load-heavy','Friday is long and you love bench, so it gets a second weekly slot. This is volume-strength work, not maxing.','Add Weight When Earned','Add weight when all 3 sets hit 8 with clean bar speed and no shoulder irritation.','2.5–3 min','https://www.youtube.com/watch?v=gRVjAtPip0Y'),
    mkEx('Low-Incline DB Press','CH','chest','Upper Chest','Dumbbells + bench','3 × 8–10','Moderate','load-moderate','Second weekly upper-chest press. This keeps pecs from falling behind delts and arms.','Add Reps First','Add reps first. Add weight once all 3 sets hit 10 with a controlled lower and stable shoulders.','90 sec','https://www.youtube.com/watch?v=IP4oeKh1Sd4'),
    mkEx('Shoulder Press (Dumbbell)','SH','shoulders','Shoulders','Dumbbells','3 × 8–10','Moderate','load-moderate','Second weekly shoulder press because you enjoy it and your delts respond well.','Add Weight When Earned','Add weight only when all 3 sets hit 10 clean reps with no lean-back or shoulder pinch.','90 sec','https://www.youtube.com/watch?v=qEwKCR5JCog'),
    mkEx('Neutral-Grip Pull-Ups','BK','back','Lats','Rack','3 × 6–8','Moderate','load-moderate','Enough vertical pulling to keep back width moving while Friday stays very aesthetic-focused.','Add Reps First','Add weight once all 3 sets hit 8 clean dead-hang reps.','2 min','https://www.youtube.com/watch?v=cd_38C6LuvY'),
    mkEx('Dumbbell Row','BK','back','Back Thickness','Dumbbell + bench','3 × 10–12/side','Moderate','load-moderate','You are already doing these well. Good support work for thickness without frying the low back.','Add Reps First','Add reps to 12 first. Add weight once all sets are clean and chest stays stable.','90 sec','https://www.youtube.com/watch?v=pYcpY20QaE8'),
    mkEx('DB Shrug','BK','back','Traps','Dumbbells','4 × 12–15','Moderate','load-moderate','Extra trap work on the long Friday session because you enjoy shrugs and they show well in clothes.','Add Weight When Earned','Add weight only when all 4 sets hit 15 with a hard top squeeze and no rolling.','75 sec','https://www.youtube.com/watch?v=cJRVVxmytaM'),
    mkEx('Lean-Away DB Lateral Raise','SH','shoulders','Shoulder Cap','Dumbbell','4 × 12–15','Light','load-light','Highest-priority aesthetic move on this day. This keeps shoulder width climbing fast.','Add Reps First','Add reps and squeeze quality. Add tiny load only when all 4 sets hit 15 with zero momentum.','60 sec','https://www.youtube.com/watch?v=S7Bjyw2ccg0'),
    mkEx('Chest Supported Reverse Fly (Dumbbell)','SH','shoulders','Rear Delts','Dumbbells + bench','3 × 12–15','Light','load-light','You are already tolerating this movement well. It stays for rear delt shape and posture.','Add Reps First','Progress reps and squeeze before adding any load.','60 sec','https://www.youtube.com/watch?v=vpWuYp2p5rE'),
    mkEx('Standing DB Curl','AR','arms','Biceps','Dumbbells','3 × 8–10','Moderate','load-moderate','Friday now openly biases arms. This is the first biceps slot of the day.','Add Weight When Earned','Add reps to 10 first. Add weight only when all 3 sets are strict and smooth.','75 sec','https://www.youtube.com/watch?v=6DeLZ6cbgWQ'),
    mkEx('Seated Incline Curl (Dumbbell)','AR','arms','Biceps Peak','Dumbbells + incline bench','3 × 10–12','Light','load-light','Second biceps slot. Stretch-position work keeps the biceps looking fuller from the front.','Add Reps First','Progress reps before weight. Load only after all 3 sets hit 12 with perfect elbow path.','60 sec','https://www.youtube.com/watch?v=soxrZlIl35U'),
    mkEx('Hammer Curl','AR','arms','Brachialis / Forearm','Dumbbells','2 × 10–12','Moderate','load-moderate','Extra arm thickness and forearm carryover on the long Friday session.','Add Weight When Earned','Add weight only when both sets hit 12 with zero swing and neutral wrist position.','60 sec','https://www.youtube.com/watch?v=BRVDS6HVR9Q'),
    mkEx('DB Rolling Triceps Extension','AR','arms','Triceps','Dumbbells','3 × 8–10','Moderate','load-moderate','Main Friday triceps builder. Arms stay heavily prioritized.','Add Weight When Earned','Add reps to 10 first. Add weight only when all 3 sets stay smooth and elbow path stays pain-free.','75 sec','https://www.youtube.com/watch?v=6IrhvGp8kRg'),
    mkEx('Seated Overhead DB Extension','AR','arms','Triceps Long Head','Dumbbell','3 × 10–12','Moderate','load-moderate','Long-head triceps volume to keep the arm look complete from the side and rear.','Add Weight When Earned','Progress reps before weight. Add the smallest jump when all 3 sets reach 12 clean reps.','60 sec','https://www.youtube.com/watch?v=fYqswDVbJDg'),
    mkEx('Close-Grip Push-Up','AR','arms','Triceps','Bodyweight','2 sets to near-failure','Rehab','load-rehab','Safe triceps finisher. Stop 2 reps before form breaks.','Add Reps Only','Add reps only when near-failure is consistently above 15 clean reps.','60 sec','https://www.youtube.com/watch?v=0LZF3OY87uU'),
    mkEx('Wrist Roller','GR','grip','Forearm Burn','Wrist roller / plate + rope','3 rounds','Moderate','load-moderate','You are already doing this and it fits the arm/forearm bias perfectly on the long Friday session.','Add Time or Weight','Add one extra up-and-down pass first, then add a small amount of weight.','60 sec','https://www.youtube.com/watch?v=-lOFG0U_rlY'),
    mkEx('Hanging Knee Raise','CO','core','Core','Pull-up bar','3 × 10–15','Rehab','load-rehab','Simple core work that fits well on a long upper-body day and helps with abdominal control.','Add Reps First','Add reps to 15 before adding a pause at the top.','60 sec','https://www.youtube.com/watch?v=Rd8jSmI2p7A'),
    mkEx('Suitcase Carry','CO','core','Obliques / Core','Dumbbell','2 × 30–40 yd/side','Moderate','load-moderate','Extra anti-side-bend work and calorie expenditure on your longest session.','Add Load Gradually','Add a small load jump only when both carries are completed without leaning or torso drift.','60–75 sec','https://www.youtube.com/watch?v=hU0GfKBZaUU')
  ],
  d6:[
    mkEx('Step-Ups (conditioning pace)','LG','legs','Conditioning / Right-Leg Bias','Bodyweight or light DB','4 × 10/side','Light','load-light','Since hiking is now monthly, Saturday gets simple conditioning step-ups. Right side still goes first.','Add Reps First','Keep these rhythmic and clean. Add reps or a small load only when heart rate stays controlled and the right side stays stable.','60 sec','https://www.youtube.com/watch?v=dQqApCGd5Ss'),
    mkEx('Spider Curl','AR','arms','Biceps','Dumbbells','3 × 10–12','Light','load-light','Strict and focused arm work. Pump quality, not load.','Add Reps First','Progress reps first. Saturday arm work stays clean and repeatable.','60 sec','https://www.youtube.com/watch?v=jmXXRM755MM'),
    mkEx('Seated Incline Curl (Dumbbell)','AR','arms','Biceps Peak','Dumbbells + incline bench','2 × 12–15','Light','load-light','Extra biceps stretch work because arms remain a major visible priority.','Add Reps First','Add reps first. Add weight only when both sets reach 15 with full control.','60 sec','https://www.youtube.com/watch?v=soxrZlIl35U'),
    mkEx('Hammer Curl','AR','arms','Brachialis','Dumbbells','3 × 10–12','Light','load-light','Arm thickness work. Keep strict, no swinging.','Add Reps First','Add reps before weight. Load is not the main priority here.','60 sec','https://www.youtube.com/watch?v=BRVDS6HVR9Q'),
    mkEx('Overhead DB Extension','AR','arms','Triceps Long Head','Dumbbell','3 × 10–12','Light','load-light','Long-head triceps for arm mass. Controlled range only.','Add Reps First','Progress reps before load. This is recovery-compatible arm work.','60 sec','https://www.youtube.com/watch?v=fYqswDVbJDg'),
    mkEx('Close-Grip Push-Up','AR','arms','Triceps','Bodyweight','2 sets to near-failure','Rehab','load-rehab','Triceps finisher. Stop 2 reps before form breaks.','Add Reps Only','Add reps only when near-failure is consistently above 15 clean reps.','60 sec','https://www.youtube.com/watch?v=0LZF3OY87uU'),
    mkEx('DB Shrug','BK','back','Traps','Dumbbells','3 × 12–15','Moderate','load-moderate','Extra trap work because you enjoy shrugs and Saturday no longer has a hike to compete with.','Add Weight When Earned','Add weight only when all 3 sets hit 15 with a hard top squeeze and no rolling.','75 sec','https://www.youtube.com/watch?v=cJRVVxmytaM'),
    mkEx('Wrist Flexion with Dumbbell','GR','grip','Wrist / Forearm','Dumbbell','2 × 15–20/side','Light','load-light','Low-stress direct forearm finisher that fits perfectly after arm work.','Add Reps First','Build smooth full-range reps to 20 before adding the smallest plate increase.','45 sec','https://www.youtube.com/watch?v=yYZPq0nm6QQ'),
    mkEx('Farmer Carry','GR','grip','Grip/Core','Dumbbells','2 × 30–40 yd','Moderate','load-moderate','Short loaded carries reinforce grip, traps, and trunk now that Saturday is no longer a hike day.','Add Load Gradually','Add a small load jump only when both carries are completed without grip breakdown.','75 sec','https://www.youtube.com/watch?v=NH7Xv-7NQNQ'),
    mkEx('Reverse Crunch','CO','core','Lower Abs','Bodyweight / bench','3 × 12–15','Light','load-light','Extra lower-ab/trunk work to increase weekly abdominal volume.','Add Reps First','Add reps first. Add a top squeeze only after 15 clean reps are easy.','45–60 sec','https://www.youtube.com/watch?v=JB2oyawG9KI'),
    mkEx('Side Plank Hip Lift','CO','core','Obliques','Bodyweight','2 × 10–12/side','Light','load-light','Extra oblique/trunk work to improve side-profile control and total abdominal training frequency.','Add Reps First','Add reps to 12 first before increasing time or adding a pause.','45–60 sec','https://www.youtube.com/watch?v=E0u-u4K5CqQ')
  ]
};
