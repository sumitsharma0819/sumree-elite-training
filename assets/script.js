...
const days={
  ...
  d4:[
    ...
    mkEx('Reverse Nordic','LG','legs','Knee Tendon','Bodyweight','2 × 6–8','Rehab','load-rehab','Patellar tendon capacity builder for hiking descents and right-knee durability.','Add Range Gradually','Start with a short range only. Add range over weeks as tendon tolerance builds.','90 sec','https://www.youtube.com/watch?v=PvJDjcfZe1c'),
