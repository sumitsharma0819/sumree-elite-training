...
const days={
  d1:[
    mkEx('Barbell Bench Press','CH','chest','Chest','Barbell','4 × 5–8','Heavy','load-heavy','Primary strength anchor. Keep it in to drive chest-triceps force production while muscle memory is returning.','Add Weight When Earned','Add weight only after all 4 sets hit 8 clean reps at ≤RPE 8 for two weeks.','2.5–3 min','https://www.youtube.com/watch?v=gRVjAtPip0Y'),
    mkEx('Low-Incline Neutral-Grip DB Press','CH','chest','Upper Chest','Dumbbells + bench','3 × 6–8','Moderate','load-moderate','Upper-chest priority press with a shoulder-friendlier grip. This is the smartest press for the next 50 days.','Add Reps First','Move from 6→8 reps first. Add 5 lb only when all sets reach 8 with zero shoulder instability.','2 min','https://www.youtube.com/shorts/W9FzXjKbYdE'),
    mkEx('Low-Incline DB Press','CH','chest','Upper Chest','Dumbbells + bench','3 × 8–10','Moderate','load-moderate','Secondary chest press for stretch-driven hypertrophy. Controlled tension matters more than max loading.','Add Reps First','Add reps first. When all sets reach 10 clean reps with a 2-sec lower, add the smallest jump.','90 sec','https://www.youtube.com/watch?v=IP4oeKh1Sd4'),
    mkEx('Low-Incline DB Squeeze Press','CH','chest','Chest','Dumbbells + bench','2 × 10–12','Light','load-light','Stretch-position chest finisher. Strong inward squeeze throughout — this is the missing isolation volume for the lagging chest.','Add Weight When Earned','Keep same weight until all sets reach 12 with strong squeeze and no shoulder shift.','75 sec','https://www.youtube.com/watch?v=sC-PHtkYqI0'),
    mkEx('Lean-Away DB Lateral Raise','SH','shoulders','Shoulder Cap','Dumbbell','3 × 12–15','Light','load-light','Extra lateral-delt bias to widen the frame and improve shoulder-to-waist contrast.','Add Reps First','Add reps and squeeze quality. Add tiny load only when all sets hit 15 with zero momentum.','60 sec','https://www.youtube.com/watch?v=S7Bjyw2ccg0'),
    ...
    mkEx('Seated Overhead DB Extension','AR','arms','Triceps Long Head','Dumbbell','2 × 10–12','Moderate','load-moderate','Long-head triceps builder to keep arm size climbing without needing more pressing volume.','Add Weight When Earned','Progress reps before weight. Add the smallest jump when all sets reach 12 with no shoulder discomfort.','60 sec','https://www.youtube.com/watch?v=fYqswDVbJDg'),
    mkEx('Push-Up Plus','CH','chest','Serratus','Bodyweight','2 × 12–15','Rehab','load-rehab','Serratus and scap control for left shoulder centering after dislocation history.','Add Control Only','Do not chase load. Add 1–2 reps or a 1-sec pause only when shoulder stays perfectly controlled.','60 sec','https://www.youtube.com/watch?v=_l3ySVKYVJ8'),
    ...
    mkEx('RKC Plank','CO','core','Core','Bodyweight','2 × 25–35s','Rehab','load-rehab','Trunk stiffness for low-back protection. Better bracing will also improve the side-profile look.','Add Time Only','Add 5–10 seconds per set before any external load variation.','60 sec','https://www.youtube.com/watch?v=0c1np4dV7ec')
  ],
  d2:[
    ...
    mkEx('Chest-Supported Incline Row','BK','back','Mid-Back','Dumbbells + bench','3 × 6–8','Heavy','load-heavy','Safe heavy rowing without lumbar cost. Keeps upper-back thickness climbing while the cut continues.','Add Weight When Earned','Push reps to the top of range first. Add load when all sets reach 8 with chest glued to bench.','2 min','https://www.youtube.com/watch?v=vmX58YYK3-8'),
    mkEx('Single-Arm Lat Row','BK','back','Lats','Dumbbell + bench','3 × 8–10/side','Moderate','load-moderate','Lat-focused hypertrophy. Pull elbow toward hip to bias width instead of just mid-back fatigue.','Add Reps First','Add reps first. Add weight once all sets hit 10 and lats are felt more than biceps.','90 sec','https://www.youtube.com/shorts/q65uDGJ9ZPs'),
    mkEx('Straight-Arm DB Pullover','BK','back','Lats','Dumbbell','2–3 × 10–12','Light','load-light','Stretch-position lat builder to help carve more width without stressing the low back.','Add Reps First','Progress reps. Add weight only when full range feels completely pain-free and lats stay loaded.','75 sec','https://www.youtube.com/watch?v=QZ_UC5SjvK4'),
    mkEx('Standing DB Curl','AR','arms','Biceps','Dumbbells','3 × 8–10','Moderate','load-moderate','Main biceps builder that should actually move some load — this is still strength work.','Add Weight When Earned','Add reps to the top of range, then increase by 2.5–5 lb total only if there is zero swing.','75 sec','https://www.youtube.com/watch?v=6DeLZ6cbgWQ'),
    ...
    mkEx('Incline Reverse Fly','SH','shoulders','Rear Delts','Dumbbells + bench','3 × 12–15','Light','load-light','Posture correction and shoulder balance. Helps the upper back look broader from the rear.','Add Reps First','Progress reps and squeeze quality long before adding any load.','60 sec','https://www.youtube.com/watch?v=vpWuYp2p5rE'),
    ...
    mkEx('Farmer Carry','GR','grip','Grip/Core','Dumbbells','3 × 35–45 sec','Moderate','load-moderate','Loaded carry — builds trunk stiffness, grip, and real-world posture without stealing from the main pulls.','Add Load Gradually','Add 2.5–5 lb per hand once you can complete full holds without grip failure.','75 sec','https://www.youtube.com/watch?v=NH7Xv-7NQNQ')
  ],
  d3:[
    ...
    mkEx('Bent-Knee Calf Raise','LG','legs','Soleus','Bodyweight / DB','2 × 15–20','Light','load-light','Low-intensity soleus work added here to reduce D4 volume while keeping weekly calf frequency. Deep stretch and hard top squeeze every rep.','Add Reps First','Build to 20 smooth reps with a deep stretch and hard top squeeze before adding load.','45–60 sec','https://www.youtube.com/watch?v=KcTEGifMTDY'),
  ...
  d4:[
    ...
    mkEx('Dumbbell Step-Ups','LG','legs','Unilateral','Dumbbells','3 × 8/side','Moderate','load-moderate','Unilateral leg strength and knee control — right side first every time.','Add Weight When Earned','Increase range control first, then reps. Add load only when both sides are stable and the right knee stays quiet.','90 sec','https://www.youtube.com/watch?v=dQqApCGd5Ss'),
    mkEx('Front-Foot Elevated Split Squat','LG','legs','Quads/Glutes','Dumbbells','3 × 8–10/side','Moderate','load-moderate','Extra unilateral volume to bring up leg symmetry without needing heavy spinal loading.','Add Weight When Earned','Increase range control first, then reps. Add load only when both sides stay stable and the right knee is quiet next day.','90 sec','https://www.youtube.com/watch?v=2C-uNgKwPLE'),
    mkEx('Heels-Elevated Goblet Squat','LG','legs','Quads','Dumbbell / KB','3 × 8–10','Moderate','load-moderate','Quad bias with minimal spinal loading. Plate or wedge under heels.','Add Reps First','Add reps to 10 first. Add weight once all sets are clean with heels elevated throughout.','90 sec','https://www.youtube.com/watch?v=CMH5QYN4saE'),
    mkEx('Single-Leg Romanian Deadlift','LG','legs','Glutes / Hamstrings','Dumbbell','2–3 × 8–10/side','Light','load-light','Hip-hinge balance and posterior-chain symmetry work. Great for right-left control without heavy fatigue.','Add Reps First','Own balance and hip position first. Add load only when all sets hit 10 with no torso twisting.','75 sec','https://www.youtube.com/watch?v=3VXmecChYYM'),
    mkEx('Paused Hip Thrust','LG','legs','Glutes','Dumbbell / Barbell + bench','2 × 10–12','Moderate','load-moderate','Direct glute isolation — the best single tool for posterior-chain symmetry. 2-sec squeeze at top. Do not hyperextend lower back at lockout.','Add Weight When Earned','Add weight after all sets reach 12 with full squeeze and no low-back compensation.','90 sec','https://www.youtube.com/watch?v=29OfN4ztW_g'),
    mkEx('Reverse Nordic','LG','legs','Knee Tendon','Bodyweight','2 × 6–8','Rehab','load-rehab','Patellar tendon capacity builder for hiking descents. Small range only to start.','Add Range Gradually','Start with a short range only. Add range over weeks as tendon tolerance builds.','90 sec','https://www.youtube.com/watch?v=PvJDjcfZe1c'),
    mkEx('Single-Leg Calf Raise','LG','legs','Calf','Bodyweight / DB','L: 3 × 12–15, R: 4 × 12–15','Moderate','load-moderate','Main calf movement. Right calf keeps the extra set until symmetry improves.','Add Weight When Earned','Add reps across all sets first. Add load only when full ROM is owned with a 1-sec pause at top.','60 sec','https://www.youtube.com/watch?v=KcTEGifMTDY'),
    mkEx('Tibialis Raise','LG','legs','Shin','Wall / bodyweight','3 × 15–20','Rehab','load-rehab','Shin strength and downhill control — prevents shin splints on hikes and supports ankle stability.','Add Reps Only','Progress reps only. Add a weight vest only once 20 reps feel easy with a 1-sec pause.','45 sec','https://www.youtube.com/watch?v=VzIcGAgBiaM'),
    mkEx('Dead Bug','CO','core','Core','Bodyweight','2 × 8/side','Rehab','load-rehab','Anti-extension core control for low-back protection and better abdominal bracing.','Add Pause Duration','Add a 1–2 sec hold at extension before any load variation.','60 sec','https://www.youtube.com/watch?v=UIL7VI5_EQg')
  ],
  d5:[
    mkEx('Neutral-Grip Pull-Ups','BK','back','Lats','Rack','3 × 6–8','Moderate','load-moderate','Second pull stimulus for width and scapular control. Neutral grip stays shoulder-friendlier.','Add Reps First','Add weight once all 3 sets hit 8 clean dead-hang reps.','2 min','https://www.youtube.com/watch?v=cd_38C6LuvY'),
    mkEx('Low-Incline DB Press','CH','chest','Upper Chest','Dumbbells + bench','3 × 8–10','Moderate','load-moderate','Second weekly upper-chest press. This is here to keep pecs catching up to the shoulders and arms.','Add Reps First','Add reps first. Add weight once all 3 sets hit 10 with a controlled lower and stable shoulders.','90 sec','https://www.youtube.com/watch?v=IP4oeKh1Sd4'),
    mkEx('One-Arm Lat Row','BK','back','Lats','Dumbbell + bench','2–3 × 10–12/side','Light','load-light','High-quality width work. Pull elbow toward hip and keep the low back out of it.','Add Reps First','Add reps before weight. Load only after all sets hit 12 and the lat does the work.','75–90 sec','https://www.youtube.com/shorts/q65uDGJ9ZPs'),
    mkEx('Straight-Arm DB Pullover','BK','back','Lats','Dumbbell','2–3 × 10–12','Light','load-light','Stretch-position lat work to reinforce the V-taper without adding joint stress.','Add Reps First','Progress reps. Add weight only when full range feels completely pain-free.','75 sec','https://www.youtube.com/watch?v=QZ_UC5SjvK4'),
    mkEx('Half-Kneeling Landmine Press','SH','shoulders','Shoulders','Barbell (corner)','3 × 8–10/side','Moderate','load-moderate','Shoulder-friendly press for upper-body density without aggravating the shoulder.','Add Reps First','Add reps first. Add weight once all sets hit 10 with no shoulder instability.','75 sec','https://www.youtube.com/watch?v=LN1zCeoIfbE'),
    mkEx('Lean-Away DB Lateral Raise','SH','shoulders','Shoulder Cap','Dumbbell','4 × 12–15','Light','load-light','Highest-priority aesthetic move right now. More lateral-delt volume will make the physique look immediately wider.','Add Reps First','Add reps and squeeze quality. Add tiny load only when all 4 sets hit 15 with zero momentum.','60 sec','https://www.youtube.com/watch?v=S7Bjyw2ccg0'),
    mkEx('Incline Bench Chest Supported Dumbbell Reverse Flys','SH','shoulders','Rear Delts','Dumbbells + bench','3 × 12–15','Light','load-light','Rear delt and posture work. Keeps the back looking broader from the rear without heavy fatigue.','Add Reps First','Progress reps and squeeze before any load change.','60 sec','https://www.youtube.com/watch?v=vpWuYp2p5rE'),
    mkEx('Standing DB Fly','CH','chest','Chest','Dumbbells','2 × 10–12','Light','load-light','Chest stretch finisher — pump and full pec range of motion. Control beats weight here entirely.','Add Reps Only','Progress reps and quality of contraction only. Load increase is not the goal.','60 sec','https://www.youtube.com/watch?v=XSdcma4EIWs'),
    mkEx('Step-Ups (light)','LG','legs','Right-Side Neural Primer','Bodyweight or light DB','2 × 8/side','Light','load-light','Neural primer for the right leg before Saturday hike. Intentionally easy — this is activation, not training.','Keep Light','This movement stays light on Friday always. Its job is priming, not loading.','75 sec','https://www.youtube.com/watch?v=dQqApCGd5Ss'),
